...
public class Story4 extends HttpServlet {
    //        String sessionId;
    String user;
    String email;
 ...
 response.setContentType("text/html");
    ...
    private void generatePage(HttpServletRequest req, PrintWriter out) throws
        Exception {
            ...
            try {
                URL story1 = new URL("http://kojsmn.383.csi.miamioh.edu:8080/story/stories/story4.sty");
            ...
            root.put("YOTEST",
                    "http://kojsmn.383.csi.miamioh.edu:8080/story/stories/story1.sty");

            root.put("PREVPAGE", null);
            root.put("NEXTPAGE", null);

            root.put("NEXTSTORY", null);
            root.put("PREVSTORY","http://kojsmn.383.csi.miamioh.edu:8080/story/servlet/story3");
