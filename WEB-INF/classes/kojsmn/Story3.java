...
public class Story3 extends HttpServlet {
    //        String sessionId;
    String user;
    String email;
 ...
 response.setContentType("text/html");
    ...
    private void generatePage(HttpServletRequest req, PrintWriter out) throws
        Exception {
            ...
            try {
                URL story1 = new URL("http://kojsmn.383.csi.miamioh.edu:8080/story/stories/story3.sty");
            ...
            root.put("PREVSTORY", "http://kojsmn.383.csi.miamioh.edu:8080/story/servlet/story2");
            root.put("NEXTSTORY","http://kojsmn.383.csi.miamioh.edu:8080/story/servlet/story4");
